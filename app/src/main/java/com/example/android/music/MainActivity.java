...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        final TextView numbers = (TextView) findViewById(R.id.allsongs);

        // Set a click listener on that View
        numbers.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                // Create a new intent to open the {@link AllSongs}
        ...
        final TextView family = (TextView) findViewById(R.id.favorites);
        // Set a click listener on that View
        family.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                // Create a new intent to open the {@link Favorites}
        ...
        final TextView colors = (TextView) findViewById(R.id.artists);
        ...
        final TextView phrases = (TextView) findViewById(R.id.albums);
